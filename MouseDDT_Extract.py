...
data = pd.DataFrame(index = [], columns = ['Chamber #', 'Animal ID', 'Impulsivity','Date', 'Block', 'Trial 1 - forced', 'Trial 2 - forced', 'Trial 3', 'Trial 4', 'Trial 5', 'Trial 6', 'Trial 7', 'Total large reward presses in free trials', 'Total small reward presses in free trials', 'Omissions in free trials'])
parsingdata = ['Chamber #', 'Animal ID', '','Date', 'Block', 'Trial 1 - forced', 'Trial 2 - forced', 'Trial 3', 'Trial 4', 'Trial 5', 'Trial 6', 'Trial 7', '', '', '']
